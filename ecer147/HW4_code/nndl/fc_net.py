...
class TwoLayerNet(object):
  ...
  def __init__(self, input_dim=3*32*32, hidden_dims=100, num_classes=10,
    ...
    # that will store the parameters
  ...
  def loss(self, X, y=None):
    ...
    z1, cache2 = relu_forward(a1)
    scores, cache3 = affine_forward(z1, self.params['W2'], self.params['b2'])
    # ================================================================ #
    # END YOUR CODE HERE
    # ================================================================ #
    ...
    # regularization.
    dz1, grads['W2'], grads['b2'] = affine_backward(dscores, cache3)
    # cache3 is stored in affine_forward to calculate derivatives  
    #
...
class FullyConnectedNet(object):
  ...
  def loss(self, X, y=None):
    ...
    for i in range(self.num_layers - 1):
        ...
        if self.use_batchnorm:
          out, cache[f"batchnorm{i+1}"] = batchnorm_forward(out,self.params[f"gamma{i+1}"],self.params[f"beta{i+1}"],self.bn_params[i])
